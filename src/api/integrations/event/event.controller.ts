...
export class EventController {
  ...
  public static readonly events = [
    ...
    'INSTANCE_DELETE',
    'STATUS_INSTANCE',
    ...EVENTOS_DEL_FORK, // fork: LID_MAPPING_UPDATE, MESSAGE_CAPPING_UPDATE, MESSAGES_REACTION, MESSAGE_RECEIPT_UPDATE, BLOCKLIST_*, GROUP_JOIN_REQUEST, CHATS_LOCK, CHATS_ARCHIVE
  ];
}
